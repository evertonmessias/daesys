<?php get_header(); ?>
<?php
$string_campos = "IN001,IN008,IN011,IN016,IN020,IN023,IN024,IN026,IN030,IN049,IN053,IN060,IN102";
$array_titulos = ["IN001 - Densidade de economias de água por ligação", "IN008 - Despesa média anual por empregado", "IN011 - Índice de macromedição", "IN016 - Índice de tratamento de esgoto", "IN020 - Extensão da rede de água por ligação", "IN023 - Índice de atendimento urbano de água", "IN024 - Índice de atendimento urbano de esgoto referido aos municípios atendidos com água", "IN026 - Despesa de exploração por m3 faturado", "IN030 - Margem da despesa de exploração", "IN049 - Índice de perdas na distribuição", "IN053 - Consumo médio de água por economia", "IN060 - Índice de despesas por consumo de energia elétrica nos sistemas de água e esgotos", "IN102 - Índice de produtividade de pessoal total (equivalente)"];
...
$snis = list_snis('select ANO,' . $string_campos . ' from wp_snis');
$ANO = "";
$IN001 = "";
$IN008 = "";
$IN011 = "";
